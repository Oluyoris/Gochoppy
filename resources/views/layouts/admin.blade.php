...
<head>
    ...
    <title>Gochoppy Admin - @yield('title', 'Dashboard')</title>
...
<nav class="gc-navbar" id="gcNavbar">
    ...
    <a href="{{ route('admin.vendors.index') }}" class="nav-link-item {{ request()->routeIs('admin.vendors.*') ? 'active' : '' }}">
        <i class="fas fa-store"></i> Vendors
    </a>

    <a href="{{ route('admin.dispatchers.index') }}" class="nav-link-item {{ request()->routeIs('admin.dispatchers.*') ? 'active' : '' }}">
    ...
    <a href="{{ route('admin.items.index') }}" class="nav-link-item {{ request()->routeIs('admin.items.*') ? 'active' : '' }}">
        <i class="fas fa-boxes-stacked"></i> Items
    </a>

    <a href="{{ route('admin.menu-requests.index') }}" class="nav-link-item {{ request()->routeIs('admin.menu-requests.*') ? 'active' : '' }}">
    ...
    {{-- SETTINGS DROPDOWN - COUPON ADDED --}}
    @php
    ...
    <div class="nav-dropdown" id="settingsDropdown">
        <button
            class="nav-dropdown-trigger {{ $settingsActive ? 'active' : '' }}"
        ...
        <div class="nav-dropdown-menu" id="settingsDropdownMenu">
            ...
            <a href="{{ route('admin.sub-admins.index') }}"
               class="{{ request()->routeIs('admin.sub-admins.*') ? 'active' : '' }}">
                <i class="fas fa-user-shield"></i> Sub Admins
            </a>

            <a href="{{ route('admin.bus-stops.index') }}"
               class="{{ request()->routeIs('admin.bus-stops.*') ? 'active' : '' }}">
...
<footer class="gc-footer">
    <small>© {{ date('Y') }} GoChoppy - Admin Panel | All Rights Reserved</small>
</footer>
