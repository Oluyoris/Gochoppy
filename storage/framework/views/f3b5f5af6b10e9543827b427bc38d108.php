...
<div style="background:#fff;border:1px solid var(--border);border-radius:16px;box-shadow:var(--shadow-md);overflow:hidden;">
    ...
    <div style="padding:18px 22px;border-bottom:1px solid var(--border-light);display:flex;align-items:center;gap:10px;">
        ...
        <span style="margin-left:auto;font-size:12px;color:var(--muted);background:var(--bg);border:1px solid var(--border);border-radius:6px;padding:3px 11px;font-weight:600;">
            <?php echo e($vendors->count()); ?> vendor<?php echo e($vendors->count() != 1 ? 's' : ''); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <span style="font-weight:700;font-size:13.5px;color:var(--text);">
                                <?php echo e($profile?->company_name ?? '<span style="color:#dc2626;">Missing Profile</span>'); ?>

                            </span>
                        </td>

                        <td>
                            <?php if($profile && $profile->type): ?>
                                <?php
                                    $typeColors = [
                                ...
                                ?>
                                <span style="background:<?php echo e($tc['bg']); ?>;color:<?php echo e($tc['color']); ?>;border:1px solid <?php echo e($tc['border']); ?>;border-radius:20px;padding:3px 11px;font-size:11.5px;font-weight:700;">
                                    <?php echo e(ucfirst($profile->type)); ?>
                        ...
                        <td style="font-size:13px;color:var(--text-body);"><?php echo e($vendor->email); ?></td>
                        <td style="font-size:13px;color:var(--text-body);"><?php echo e($vendor->phone); ?></td>
                        <td style="font-size:13px;color:var(--muted);max-width:130px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"><?php echo e($vendor->address ?? '—'); ?></td>

                        
                        <td style="font-size:13px;color:var(--text-body);">
                            <?php if($profile && $profile->popular_bus_stop_id && $profile->popularBusStop): ?>
                                <span style="background:var(--teal-soft);color:var(--teal-dark);padding:4px 10px;border-radius:6px;font-size:12.5px;font-weight:600;">
                                    <?php echo e($profile->popularBusStop->name); ?>
                        ...
                        <td class="text-end">
                            <div style="display:inline-flex;align-items:center;gap:5px;">
                                ...
                                <a href="<?php echo e(route('admin.vendors.transactions', $vendor)); ?>"
    ...
    <div style="padding:13px 22px;border-top:1px solid var(--border-light);background:var(--bg);font-size:12.5px;color:var(--muted);font-weight:500;text-align:center;">
        Showing <?php echo e($vendors->count()); ?> vendor<?php echo e($vendors->count() != 1 ? 's' : ''); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hp\Projects\gochoppy\backend\resources\views/admin/vendors/index.blade.php ENDPATH**/ ?>